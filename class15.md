...
> Q: how many genes are up and down regulated? 4349 genes up regulated
> and 4396 genes down regulated at the default 0.1 p-value cutoff

``` r
plot(res$log2FoldChange, -log(res$padj))
```

![](class15_files/figure-commonmark/plot-1.png)
...
![](class15_files/figure-commonmark/plot-2.png)
...
![](Cellular%20responses%20to%20stimuli.png) ![](R-HSA-1430728.png)

> Q: What pathway has the most significant “Entities p-value”? Do the
> most significant pathways listed match your previous KEGG results?
> What factors could cause differences between the two methods?

Cell cycle, Mitotic. Kegg separates significant pathways based on
whether the genes are up or down regulated, thus it is hard to compare
the most significant pathways between the two methods. However, the most
significant pathway is from a down-regulated gene, a pathway on
organelle fission.
